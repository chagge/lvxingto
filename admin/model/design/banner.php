...
class ModelDesignBanner extends Model {
	public function addBanner($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "' , lazyload_img = '" . $this->db->escape($data['lazyload_img']) . "'");
	...
	public function editBanner($banner_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "' , lazyload_img = '" . $this->db->escape($data['lazyload_img']) . "' WHERE banner_id = '" . (int)$banner_id . "'");
