...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *, (SELECT CONCAT(c.firstname) FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer FROM `" . DB_PREFIX . "order` o WHERE o.order_id = '" . (int)$order_id . "'");
	...
	public function getOrders($data = array()) {
		...
		if (!empty($data['filter_customer'])) {
			$sql .= " AND CONCAT(o.firstname) LIKE '%" . $this->db->escape($data['filter_customer']) . "%'";
		}
	...
	public function getTotalOrders($data = array()) {
		...
		if (!empty($data['filter_customer'])) {
			$sql .= " AND CONCAT(firstname) LIKE '%" . $this->db->escape($data['filter_customer']) . "%'";
		}
