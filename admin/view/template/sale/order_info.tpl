        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><a href="<?php echo $customer; ?>" target="_blank"><?php echo $firstname; ?></a></td>
              </tr>
              <?php } else { ?>
              <tr>
                <td><?php echo $text_customer; ?></td>
          ...
          <div class="tab-pane" id="tab-product">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <td class="text-left"><?php echo $column_product_img; ?></td>
              ...
              <tbody>
                ...
                <tr>
                	<td><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['image']; ?>"></a></td>
