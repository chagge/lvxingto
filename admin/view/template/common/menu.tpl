<ul id="menu">
    ...
    <ul>
      <li><a class="parent"><?php echo $text_setting; ?></a>
      	<ul>
      		...
      		<li><a href="<?php echo $url_official_store_signs; ?>"><?php echo $text_official_store_signs; ?></a></li>
      </li>
      	</ul>
      </li>
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $url_image_manager; ?>"><?php echo $text_image_manager; ?></a></li>
    </ul>
  </li>
