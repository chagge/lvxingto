      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-site_settings" data-toggle="tab"><?php echo $tab_site_settings; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-wxqr"><?php echo $entry_wxqr; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-wxqr" data-toggle="image" class="img-thumbnail"><img src="<?php echo $wxqr; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_wxqr" value="<?php echo $config_wxqr; ?>" id="input-wxqr" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mbqr"><?php echo $entry_mbqr; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-mbqr" data-toggle="image" class="img-thumbnail"><img src="<?php echo $mbqr; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_mbqr" value="<?php echo $config_mbqr; ?>" id="input-mbqr" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price_background"><?php echo $entry_price_background; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-price_background" data-toggle="image" class="img-thumbnail"><img src="<?php echo $price_background; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_price_background" value="<?php echo $config_price_background; ?>" id="input-price_background" />
                </div>
              </div>
              <div class="form-group required">
			...
			<div class="tab-pane" id="tab-site_settings">
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-home_nvgap"><?php echo $entry_home_nvgap; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_home_nvgap" value="<?php echo $config_home_nvgap; ?>" placeholder="<?php echo $entry_home_nvgap; ?>" id="input-home_nvgap" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $entry_full_screen; ?>"><?php echo $entry_full_screen; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_full_screen) { ?>
                    <input type="radio" name="config_full_screen" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_full_screen" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_full_screen) { ?>
                    <input type="radio" name="config_full_screen" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_full_screen" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
