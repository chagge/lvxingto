    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-lazyload_img"><?php echo $entry_lazyload_img; ?></label>
                <div class="col-sm-10"><a href="" id="lazyload_img" data-toggle="image" class="img-thumbnail"><img src="<?php echo $img_lazyload_img; ?>" alt="" title="" data-placeholder="<?php echo $entry_lazyload_img; ?>" /></a>
                  <input type="hidden" name="lazyload_img" value="<?php echo $lazyload_img; ?>" id="input-lazyload_img" />
                </div>
              <?php if ($error_lazyload_img) { ?>
              <div class="text-danger"><?php echo $error_lazyload_img; ?></div>
              <?php } ?>
              </div>
