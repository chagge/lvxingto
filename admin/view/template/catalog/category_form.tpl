        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-title<?php echo $language['language_id']; ?>"><?php echo $entry_url; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][url]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['url'] : ''; ?>" placeholder="<?php echo $entry_url; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-whether"><span data-toggle="tooltip" title="<?php echo $helper_whether; ?>"><?php echo $entry_whether; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                      <?php foreach ($categorspositions as $categorsposition) { ?>
                      <?php if (!empty($categorsposition['0'])) { ?>
                      <label><span><?php echo $categorsposition['position_name']?></span><input type="checkbox" name="whether[<?php echo $categorsposition['category_position_id']?>][]" value="<?php echo $categorsposition['position_value']?>" checked="checked" id="input-whether" class="category-select" /></label>
                      <?php } else { ?>
                      <label><span><?php echo $categorsposition['position_name']?></span><input type="checkbox" name="whether[<?php echo $categorsposition['category_position_id']?>][]" value="<?php echo $categorsposition['position_value']?>" id="input-whether" class="category-select" /></label>
                      <?php } ?>
                      <?php } ?>
                  </div>
                </div>
