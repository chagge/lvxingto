...
// Help
$_['help_address_format']     = 'First Name = {firstname}<br />Address 1 = {address_1}<br />City = {city}<br />Postcode = {postcode}<br />Zone = {zone}<br />Zone Code = {zone_code}<br />Country = {country}';
