...
class ControllerSaleCustomerGroup extends Controller {
	...
	protected function getForm() {
		...
		$customer_group_info= array (
				'permission'=>unserialize($customer_group_info['permission'])
		);
		...
		} elseif (isset($customer_group_info['permission']['access'])) {
			$data['access'] = $customer_group_info['permission']['access'];
		} else {
			$data['access'] = array();
		}
		...
		} elseif (isset($customer_group_info['permission']['modify'])) {
			$data['modify'] = $customer_group_info['permission']['modify'];
		} else {
			$data['modify'] = array();
		}
