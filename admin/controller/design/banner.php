...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_lazyload_img'] = $this->language->get('entry_lazyload_img');
		...
		if (isset($this->error['lazyload_img'])) {
			$data['error_lazyload_img'] = $this->error['lazyload_img'];
		} else {
			$data['error_lazyload_img'] = '';
		}
		...
		if (isset($this->request->post['lazyload_img'])) {
			$data['lazyload_img'] = $this->request->post['lazyload_img'];
		} else{
			$data['lazyload_img'] = $banner_info['lazyload_img'];
		}
			$data['img_lazyload_img']=DIR_IMAGE . $data['lazyload_img'];
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['lazyload_img']) < 3) || (utf8_strlen($this->request->post['lazyload_img']) > 64)) {
			$this->error['error_lazyload_img'] = $this->language->get('error_lazyload_img');
		}
