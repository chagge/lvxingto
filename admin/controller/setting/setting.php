...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_wxqr'] = $this->language->get('entry_wxqr');
		$data['entry_mbqr'] = $this->language->get('entry_mbqr');
		$data['entry_icon'] = $this->language->get('entry_icon');
		$data['entry_price_background'] = $this->language->get('entry_price_background');
		...
		$data['entry_home_nvgap'] = $this->language->get('entry_home_nvgap');
		...
		$data['tab_site_settings'] = $this->language->get('tab_site_settings');
		...
		if (isset($this->request->post['config_image']) && is_file(DIR_IMAGE . $this->request->post['config_image'])) {
			...
			$data['thumb'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}

		$data['placeholder'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		...
		if (isset($this->request->post['config_logo']) && is_file(DIR_IMAGE . $this->request->post['config_logo'])) {
			...
			$data['logo'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_icon']) && is_file(DIR_IMAGE . $this->request->post['config_icon'])) {
			...
			$data['icon'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}
		
		if (isset($this->request->post['config_wxqr'])) {
			$data['config_wxqr'] = $this->request->post['config_wxqr'];
		} else {
			$data['config_wxqr'] = $this->config->get('config_wxqr');
		}
		
		if (isset($this->request->post['config_wxqr']) && is_file(DIR_IMAGE . $this->request->post['config_wxqr'])) {
			$data['wxqr'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
		} elseif ($this->config->get('config_wxqr') && is_file(DIR_IMAGE . $this->config->get('config_wxqr'))) {
			$data['wxqr'] = $this->model_tool_image->resize($this->config->get('config_wxqr'), 100, 100);
		} else {
			$data['wxqr'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}
		
		if (isset($this->request->post['config_mbqr'])) {
			$data['config_mbqr'] = $this->request->post['config_mbqr'];
		} else {
			$data['config_mbqr'] = $this->config->get('config_mbqr');
		}
		
		if (isset($this->request->post['config_mbqr']) && is_file(DIR_IMAGE . $this->request->post['config_mbqr'])) {
			$data['mbqr'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
		} elseif ($this->config->get('config_mbqr') && is_file(DIR_IMAGE . $this->config->get('config_mbqr'))) {
			$data['mbqr'] = $this->model_tool_image->resize($this->config->get('config_mbqr'), 100, 100);
		} else {
			$data['mbqr'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}
		
		if (isset($this->request->post['config_price_background'])) {
			$data['config_price_background'] = $this->request->post['config_price_background'];
		} else {
			$data['config_price_background'] = $this->config->get('config_price_background');
		}
		
		if (isset($this->request->post['config_price_background']) && is_file(DIR_IMAGE . $this->request->post['config_price_background'])) {
			$data['price_background'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
		} elseif ($this->config->get('config_price_background') && is_file(DIR_IMAGE . $this->config->get('config_price_background'))) {
			$data['price_background'] = $this->model_tool_image->resize($this->config->get('config_price_background'), 100, 100);
		} else {
			$data['price_background'] = $this->model_tool_image->resize('tools/no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_home_nvgap'])) {//首页导航下的间隙
			$data['config_home_nvgap'] = $this->request->post['config_home_nvgap'];
		} elseif ($this->config->get('config_home_nvgap')) {
			$data['config_home_nvgap'] = $this->config->get('config_home_nvgap');
		} else {
			$data['config_home_nvgap'] = '10px';
		}
		
		if (isset($this->request->post['config_full_screen'])) {
			$data['config_full_screen'] = $this->request->post['config_full_screen'];
		} else {
			$data['config_full_screen'] = $this->config->get('config_full_screen');
		}

		if (isset($this->request->post['copyright'])) {
			$data['copyrights'] = $this->request->post['copyright'];
		} elseif ($this->config->get('copyright')) {
			$data['copyrights'] = $this->config->get('copyright');
		} else {
	...
	public function template() {
		...
		if (is_file(DIR_IMAGE . 'templates/' . basename($this->request->get['template']) . '.png')) {
			...
			$this->response->setOutput($server . 'image/tools/no_image.png');
		}
	}
