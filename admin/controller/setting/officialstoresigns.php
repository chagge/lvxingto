<?php
class ControllerSettingOfficialstoresigns extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$this->response->setOutput($this->load->view('setting/officialstoresigns_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		$data['entry_whether'] = $this->language->get('entry_whether');
		$data['entry_category'] = $this->language->get('entry_category');
		$data['entry_homenv'] = $this->language->get('entry_homenv');
		$data['entry_homecategory'] = $this->language->get('entry_homecategory');
		$data['entry_sellernv'] = $this->language->get('entry_sellernv');
		$data['entry_sellerbar'] = $this->language->get('entry_sellerbar');
		$data['entry_accountnv'] = $this->language->get('entry_accountnv');
		$data['entry_accountbar'] = $this->language->get('entry_accountbar');

		$data['help_filter'] = $this->language->get('help_filter');
		$data['help_keyword'] = $this->language->get('help_keyword');
		$data['help_top'] = $this->language->get('help_top');
		$data['helper_whether'] = $this->language->get('helper_whether');
		...
		$categorspositions=$this->model_catalog_category->getCategoriesPosition();
		
		if (isset($this->request->post['whether']['acc'])) {
			$data['whether'] = $this->request->post['whether']['acc'];
		} elseif (!empty($category_info)) {
			$data['whether'] = @$category_info['whether']['acc'];
		} else {
			$data['whether'] = array();
		}
		
		$position=@unserialize($category_info['whether']);
		//合并两个数组
		$data['categorspositions']=$this->arrpreg($categorspositions , $position);
		...
		$this->response->setOutput($this->load->view('setting/officialstoresigns_form.tpl', $data));
	}
	...
	function arrpreg($categorspositions , $position){
		...
		$arr = array();
		foreach ($categorspositions as $k => $r) {
			foreach($r as $k1 => $r1){
				$arr[$k][$k1] = $r1;
			}
		}
