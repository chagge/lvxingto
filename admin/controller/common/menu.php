...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_sysinfo']   = $this->language->get('text_sysname');
		$data['text_image_manager']   = $this->language->get('text_image_manager');
		$data['text_official_store_signs']   = $this->language->get('text_official_store_signs');
		...
		$data['url_image_manager']    = $this->url->link('tool/image_manager', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_official_store_signs']    = $this->url->link('setting/officialstoresigns', 'token=' . $this->session->data['token'], 'SSL');
