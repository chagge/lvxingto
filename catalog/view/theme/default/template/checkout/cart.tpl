  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row left-right">
        <div class="col-sm-4 col-sm-offset-8 cart-left">
          <table class="table table-bordered">
	  ...
	  <div class="row bottom-margin">
		<div class="col-sm-4 hidden-xs"></div><div class="col-sm-4 hidden-xs"></div>
	  <div class="col-sm-4 cart-left">
		<div class="pull-left col-sm-5 cart-left"><a href="<?php echo $continue; ?>" class="btn btn-default"><?php echo $button_shopping; ?></a></div>
		<div class="pull-right col-sm-5 cart-left"><a href="<?php echo $checkout; ?>" class="btn btn-primary"><?php echo $button_checkout; ?></a></div>
	  </div>
	  </div>
