...
<meta name="msvalidate.01" content="EA3E421396AD396D37B3FA28E3F18669" />
<meta name="baidu-site-verification" content="cgR2ljqFR6" />
<meta baidu-gxt-verify-token="75e095ea08fd827ec1f9c22ed07d42e6">
<?php if ($icon) { ?>
...
<nav id="top" class="navbar-fixed-top hidden-xs">
  <div class="container">
  <?php if ($logged) { ?>
  	<div class="wecome"><span class="hidden-xs"><?php echo $text_logged; ?></span><a href="<?php echo $logout; ?>"><i class="visible-xs fa fa-sign-out"></i></a></div>
  	<?php } else { ?>
  	<div class="wecome"><span class="hidden-xs"><?php echo $text_welcome; ?></span><a href="<?php  echo $login; ?>"><i class="visible-xs user-ico fa fa-sign-in"></i></a><a class="hidden-xs" href="<?php echo $login; ?>"><?php echo $text_login; ?></a><span class="hidden-xs"><?php echo $text_or; ?></span><a href="<?php  echo $register; ?>"><i class="visible-xs fa fa-key"></i></a><a class="hidden-xs" href="<?php echo $register; ?>"><?php echo $text_register; ?></a><span class="hidden-xs">！</span></div>
  	<?php } ?>
    <?php echo $currency; ?>
    <?php echo $language; ?>
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_my_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-th-large"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_my_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right dropdown-menu-my">
        ...
        <li class="dropdown"><a href="<?php echo $businesses; ?>"><i class="fa fa-paper-plane"></i><span class="hidden-xs hidden-sm hidden-md header-contact-us"><?php echo $text_businesses; ?></span><span class="caret"></span></a>
        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-my">
        	<li><a>已卖出商品</a></li>
        </ul>
        </li>
        <li class="dropdown"><a><i class="fa fa-crosshairs"></i><span class="hidden-xs hidden-sm hidden-md header-contact-us"><?php echo $text_map; ?></span><span class="caret"></span></a>
...
<?php if ($categories) { ?>
<div style="background-color: <?php echo $home_full_screen; ?>">
<div class="container">
  <nav id="menu" class="navbar home-nvbottom hidden-xs">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse nav-nopadding">
...
<div style="height: <?php echo $home_nvgap; ?>"></div>
<?php } ?>
