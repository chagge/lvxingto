...
<div class="container">
  ...
  <div class="row">
	...
	<div class="col-sm-7"><?php echo $content_top; ?></div>
	<?php $class = 'col-sm-5'; ?>
	<?php } else { ?>
    <?php $class = 'col-sm-12'; ?>
	<?php } ?>
	...
	<?php if ($ismobile!==true) { ?>
	<div class="row">
		<p class="col-sm-6"><?php echo $heading_title; ?></p>
      	<p class="col-sm-6 login-right-title"><?php echo $text_account_already; ?></p>
	</div>
	<?php } ?>
	...
	<?php } ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <div class="col-sm-12">
              <select name="country_id" id="input-country" class="form-control">
                <option value=""><?php echo $text_select_zoon; ?></option>
          ...
          <div class="form-group required captcha-module">
          	<div class="col-sm-9">
                ...
                <div calss="col-sm-3">
                <img class="captcha-img" src="<?php echo $captcha_url.'&zoom=1.7';?>" onclick= "this.src='<?php echo $captcha_url.'&zoom=1.7';?>'+Math.random()" style="cursor: pointer; vertical-align:middle" title="看不清？点击更换！"/>
            </div>
          </div>
          <?php foreach ($custom_fields as $custom_field) { ?>
