...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if($this->ismobile->ismobile()==true){//=ture是移动设备
			$data['ismobile'] = true;
		}else{
			$data['ismobile'] = false;
		}
		...
		$data['text_select_zoon'] = $this->language->get('text_select_zoon');
		...
		$data['footer'] = $this->load->controller('common/p_footer');
		$data['header'] = $this->load->controller('common/p_header');
	...
	public function validate() {
		if($this->ismobile->ismobile()==false){//=ture是移动设备
		...
		//判断验证码是否输入
		if (strtolower($this->session->data['captchaword'])!==strtolower($this->request->post['captcha'])) {
