...
class ModelCatalogProduct extends Model {
	...
	public function getproductstoreinfo($product_id){
		//查店铺id号
		if (isset($product_id)) {
			$query=$this->db->query("SELECT * FROM" . DB_PREFIX . " product_to_store a LEFT JOIN " . DB_PREFIX . "store b on a.store_id = b.store_id where a.product_id=" . $product_id);
		}
		return $query->row;
	}
}
