...
class ModelAccountOrder extends Model {
	...
	public function product_payment_total($product_id){
		$query = $this->db->query("SELECT quantity FROM " . DB_PREFIX . "order_product WHERE product_id = '" . (int)$product_id . "'");

		//var_dump(array_column($query->rows, 'quantity'));//返回数组中的值
		return array_sum(array_column($query->rows, 'quantity'));//返回数组中的和
	}
}