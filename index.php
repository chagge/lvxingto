...
// 微信接口
$registry->set('wxbizmsgcrypt', new Wxbizmsgcrypt($token, $encodingAesKey, $appId));

// 验证码类
$registry->set('captcha', new Captcha($registry));

// 移动设备判断
$registry->set('ismobile', new Ismobile());
